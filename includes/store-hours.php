...
<html lang="en" xml:lang="en"><head>
    ...
    if($store_hours->is_open()) {
        echo "<strong style='color:green;'>Yes, we're open! Today's hours are </strong>" . $store_hours->hours_today() . ".";
    } else {
        echo "<strong style='color:red;'>Sorry, we're closed.</strong>". $store_hours->hours_today(). ".";
    }
